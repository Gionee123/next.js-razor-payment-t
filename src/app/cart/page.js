...
export default function Cart() {
    ...
    const placeOrder = () => {
        ...
        axios.post(
            "https://node-js-razor-payment-api.onrender.com/api/frontend/orders/place-order", datasava
    ...
    const openPaymentPopUp = (order_id, razorpayOrder) => {
        const options = {
            ...
            handler: function (response) {
                ...
                alert('success')
                axios.post("https://node-js-razor-payment-api.onrender.com/api/frontend/orders/place-order",
        ...
        rzp1.on("payment.failed", function (response) {
            ...
            alert("Payment failed. Please try again.");
            axios.post("https://node-js-razor-payment-api.onrender.com/api/frontend/orders/confirm-order",
